...
class MySqlHelper(ctx: Context) : ManagedSQLiteOpenHelper(ctx, "albumdb") {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        for (i in 8..19) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (stadiumStickers?.get(i) ?: "stadium"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 20..31) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (hostCitiesStickers?.get(i) ?: "host city"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 32..51) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (russiaStickers?.get(i) ?: "russia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 52..71) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (saudiArabiaStickers?.get(i) ?: "saudi arabia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 72..91) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (egyptStickers?.get(i) ?: "egypt"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 92..111) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (uruguayStickers?.get(i) ?: "uruguay"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 112..131) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (portugalStickers?.get(i) ?: "portugal"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 132..151) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (spainStickers?.get(i) ?: "spain"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 152..171) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (moroccoStickers?.get(i) ?: "morocco"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 172..191) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (iranStickers?.get(i) ?: "iran"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 192..211) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (franceStickers?.get(i) ?: "france"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 212..231) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (australiaStickers?.get(i) ?: "australia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 232..251) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (peruStickers?.get(i) ?: "peru"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 252..271) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (denmarkStickers?.get(i) ?: "denmark"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 272..291) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (argentinaStickers?.get(i) ?: "argentina"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 292..311) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (icelandStickers?.get(i) ?: "iceland"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 312..331) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (croatiaStickers?.get(i) ?: "croatia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 332..351) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (nigeriaStickers?.get(i) ?: "nigeria"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 352..371) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (brazilStickers?.get(i) ?: "brazil"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 372..391) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (switzerlandStickers?.get(i) ?: "switzerland"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 392..411) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (costaRicaStickers?.get(i) ?: "costa rica"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 412..431) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (serbiaStickers?.get(i) ?: "serbia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 432..451) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (germanyStickers?.get(i) ?: "germany"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 452..471) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (mexicoStickers?.get(i) ?: "mexico"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 472..491) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (swedenStickers?.get(i) ?: "sweden"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 492..511) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (koreaRepublicStickers?.get(i) ?: "korea republic"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 512..531) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (belgiumStickers?.get(i) ?: "belgium"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 532..551) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (panamaStickers?.get(i) ?: "panama"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 552..571) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (tunisiaStickers?.get(i) ?: "tunisia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 572..591) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (englandStickers?.get(i) ?: "england"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 592..611) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (polandStickers?.get(i) ?: "poland"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 612..631) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (senegalStickers?.get(i) ?: "senegal"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 632..651) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (colombiaStickers?.get(i) ?: "colombia"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 652..671) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (japanStickers?.get(i) ?: "japan"),
                    Sticker.COLUMN_NUMBER to i,
        ...
        for (i in 672..681) {
            db.insert(Sticker.TABLE_NAME,
                    Sticker.COLUMN_NAME to (legendsStickers?.get(i) ?: "legends"),
                    Sticker.COLUMN_NUMBER to i,
